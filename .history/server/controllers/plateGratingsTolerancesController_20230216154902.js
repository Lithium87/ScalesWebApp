...
exports.updatePlateGratingsTolerancesById = asyncHandler (async (req, res) => {
  ...
  if (updatedPlateGratingsTolerancesById) {
    (plateGridName = req.body.plateGridName), (cardNumber =
      req.body.cardNumber), (nominal = req.body.nominal), (nominalMin1 =
      req.body.nominalMin1), (nominalMin2 =
      req.body.nominalMin2), (nominalMax1 = req.body.noinalMax1), (nominalMax2 =
