...
exports.updatePlateGratingsTolerancesById = asyncHandler (async (req, res) => {
  ...
  if (updatedPlateGratingsTolerancesById) {
    updatedPlateGratingsTolerancesById.plateGridName = req.body.plateGridName;
    updatedPlateGratingsTolerancesById.cardNumber = req.body.cardNumber;
    updatedPlateGratingsTolerancesById.nominal = req.body.nominal;
    updatedPlateGratingsTolerancesById.nominalMin1 = req.body.nominalMin1;
    updatedPlateGratingsTolerancesById.nominalMin2 = req.body.nominalMin2;
    updatedPlateGratingsTolerancesById.nominalMax1 = req.body.nominalMax1;
    updatedPlateGratingsTolerancesById.nominalMax2 = req.body.nominalMax2;
