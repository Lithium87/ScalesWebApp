...
const importData = async () => {
  try {
    ...
    await new Material.bulkCreate (materials);
    await new Measurement.bulkCreate (measurements);
    await new Operator.bulkCreate (operators);
    await new Scale.bulkCreate (scales);
    await new User.bulkCreate (users);
    await new Zvena.bulkCreate (zvena);
