...
const importData = async () => {
  try {
    await Material.destroy ({where: {}}, {sequelize});
    await Measurement.destroy ({where: {}}, {sequelize});
    await Operator.destroy ({where: {}}, {sequelize});
    await Scale.destroy ({where: {}}, {sequelize});
    await User.destroy ({where: {}}, {sequelize});
    await Zvena.destroy ({where: {}}, {sequelize});
