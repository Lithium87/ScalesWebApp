...
const importData = async () => {
  try {
    ...
    await Material.findOrCreate (materials);
    await Measurement.findOrCreate (measurements);
    await Operator.findOrCreate (operators);
    await Scale.findOrCreate (scales);
    await User.findOrCreate (users);
    await Zvena.findOrCreate (zvena);
