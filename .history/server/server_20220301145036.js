...
sequelize
  .sync ({force: true})
  .then (() => Scale.bulkCreate (scales))
  .then (() => Material.bulkCreate (materials))
  .then (() => Zvena.bulkCreate (zvena))
  .then (() => User.bulkCreate (users))
  .then (() => Operator.bulkCreate (operators))
  .then (() => Measurement.bulkCreate (measurements))
  .then (() => console.log ('DB is ready'.cyan.bold));
