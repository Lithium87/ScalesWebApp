...
const PlateGratingsTolerancesScreen = ({tolerancesById}) => {
  ...
  const displayEditForm = () => {
    <EditPlateGratingsTolerancesScreen tolerancesById={tolerancesById} />;
  };
